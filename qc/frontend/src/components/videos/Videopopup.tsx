            ...
            {videotype.map((option) => (
              <MenuItem key={option.value} value={option.value}>
                {option.label}
				  ...
				  <div className="form-group col-md-6 mb-3">
            <TextField id="outlined-url" label="Url" variant="outlined" value="" size='small'/>
					</div>
								  
					<div className="form-group col-md-6 mb-3">
            <TextField id="displayorder" label="Display Order" variant="outlined" value="" size='small'/>
					  </div>
					  
					<div className="form-group col-md-6 mb-3">
          <TextField id="displayorder" label="Description" variant="outlined" value="" size='small'/> 
					</div>
					<div className="form-group col-md-6 mb-3">
          <TextField id="displayorder" label="Pop Up Description" variant="outlined" value="" size='small'/> 
					  </div>
					  <div className="form-group col-md-6 mb-3">
