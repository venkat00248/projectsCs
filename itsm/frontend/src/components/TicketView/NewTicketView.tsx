...
import NewTickets from "../uidashboard/NewTickets";
...
const NewTicketview: React.FC<ticketView> = ({ticket, view = true, rfcno}) => {
    console.log("ticket",ticket, rfcno)
  ...
  return (
    <div className=" container">
      ...
      >
        ...
        <Modal.Body >
          <NewView ticket= {ticket} ticketID = {rfcno}/>
