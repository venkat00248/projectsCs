              ...
              <div className="col-md-4">
                <FormControl sx={{ m: 1, width: "100%" }}>
                  <TextField
                    ...
                    onChange={(e) => {
                      const nameValue = e.target.value.replace(/[^a-zA-Z0-9 ]/g, "");
              ...
              <div className="col-md-6">
                <FormControl sx={{ m: 1, width: "100%" }}>
                  <TextField
                    ...
                    onChange={(e) => {
                      const addressValue = e.target.value.replace(/[^a-zA-Z/,-]/g, "");
                ...
                <FormControl sx={{ m: 1, width: "100%" }}>
                  <TextField
                    ...
                    onChange={(e) => {
                      const countryValue = e.target.value.replace(/[^a-zA-Z ]/g, "");
              ...
              <div className="col-md-4">
                <FormControl sx={{ m: 1, width: "100%" }}>
                  <TextField
                    ...
                    onChange={(e) => {
                      const stateValue = e.target.value.replace(/[^a-zA-Z ]/g, "");
